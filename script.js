const contractAirDropAddress = "0xd9145CCE52D386f254917e481eB44e9943F39138"; //Сюда адрес контракта
const contractAirDropABI = [
	[
        ...
        },
        {
            ...
            "name": "airdropTokenWithTransferFrom",
            "outputs": [],
            "stateMutability": "nonpayable",
            "type": "function"
        },
...
async function airdropTokensWithTransfer() {
    var options = document.getElementById('addresses').selectedOptions;
	var values = Array.from(options).map(({ value }) => value);
	console.log(values);  
	await  contractAirDrop.airdropTokensWithTransferToArray(values, 1);
}